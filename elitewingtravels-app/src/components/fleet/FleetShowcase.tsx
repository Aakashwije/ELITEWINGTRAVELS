...
export default function FleetShowcase() {
    ...
    return (
        <section className="py-24 bg-gradient-to-b from-[var(--color-bg)] via-slate-50 to-[var(--color-bg)]">
                            ...
                            <Link href={`/fleet/${vehicle.slug}`} key={vehicle.slug} className="block group">
                                <div className="bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100/80 h-full flex flex-col hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                                    ...
                                    <div className="relative h-64 overflow-hidden bg-gray-50">
                                        ...
                                        />
                                        {/* Hover Overlay */}
                                        <div className="absolute inset-0 bg-black/85 flex flex-col justify-center items-center p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20 backdrop-blur-sm">
